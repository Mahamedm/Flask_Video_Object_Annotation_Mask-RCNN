...
def display_instances(image, boxes, masks, class_ids, class_names,
                      ...
                      colors=None, captions=None,save_dir=None, file_name="output.jpg"):
    """
    ...
    if save_dir is None:
        ...
        file_location = os.path.join(save_dir)
    ax.imshow(masked_image.astype(np.uint8))
    plt.savefig(f"{file_location}/{file_name}",bbox_inches='tight',pad_inches=0.0)
    if auto_show:
        plt.show()
